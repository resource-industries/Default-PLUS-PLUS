...
help.info = [[
            <text x="500" y="30" font-size="]]..fontSize..[[" text-anchor="middle">
                ...
                <tspan x="500" dy="]]..lineSpace*2 ..[[" style="font-weight: bold; " font-size="]]..fontSize*1.8 ..[[">]]..'Default ++ v3.3 for Release 1.0'..[[</tspan>
                <tspan x="500" dy="]]..lineSpace..[[">]]..'The touch screen revolutionary hud and flight script!'..[[</tspan>
                <tspan x="500" dy="]]..lineSpace..[[">]]..'By Jeronimo 2016-2022'..[[</tspan>
