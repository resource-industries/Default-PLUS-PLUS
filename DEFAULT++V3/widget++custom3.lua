...
function WidgetsPlusPlusCustom.SVG_Update(self)
    ...
    if delay >= 60 then
        ...
        local FIVS = intersectVecSphere(cWPx, cWPy, cWPz, cWOFx, cWOFy, cWOFz, 13856549.3576,7386341.6738,-258459.8925, 18000000) --::pos{0,0,13856549.3576,7386341.6738,-258459.8925}
        local szcnx, szcny, szcnz = normalizeVec(cWPx-13856549.3576, cWPy-7386341.6738, cWPz+258459.8925)
        local CIVS = intersectVecSphere(cWPx, cWPy, cWPz, szcnx, szcny, szcnz, 13856549.3576,7386341.6738,-258459.8925, 18000000)
